                  ...
                  <>
                    ...
                    >
                      <View style={styles.addquesManually}>
                        <AddQues />
                        <RNText style={styles.addquestiontext} font='MontserratSemiBold' colortype="white">Add Question Manually</RNText>
                      </View>
                    </TouchableOpacity>
                    <TouchableOpacity
                      activeOpacity={0.8}
                      ...
                      <View style={styles.seeAllQues}>
                        <AddQues />
                        <RNText style={styles.addquestiontext} font='MontserratSemiBold' colortype="white">See All the question</RNText>
                      </View>
                    </TouchableOpacity>
